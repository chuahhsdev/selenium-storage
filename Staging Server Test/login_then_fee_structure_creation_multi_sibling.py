...
fee_name = ["EDP - Half Day - 2025 Test (Sibling)", "EDP - Full Day - 2025 Test (Sibling)", 
"QF1 - Half Day - 2025 Test (Sibling)", "QF1 - Full Day - 2025 Test(Sibling)", 
"QF2 - Half Day - 2025 Test (Sibling)", "QF2 - Full Day - 2025 Test (Sibling)",
"QF3 - Half Day - 2025 Test (Sibling)", "QF3 - Full Day - 2025 Test (Sibling)"]
...
for fee_names in fee_name:
    ...
    time.sleep(1)  # Wait for the fee structure to load
    # Time to edit the student fee!
    school_default_field = driver.find_element(By.ID, "school_default")
    school_default_val = float(school_default_field.get_attribute('value'))
    print("Gotten value: "+str(school_default_val))
    school_adjust_field = driver.find_element(By.ID, "school_adjust")  # Adjust selector
    school_default_val_adjust = school_default_val - (school_default_val * (10/100))
    print("Calculated value: "+str(school_default_val_adjust))
    #driver.execute_script("arguments[0].value = arguments[1];", school_adjust_field, str(school_default_val_adjust)) #Javascript stuff. Execute_script is for Javascript.
    #school_adjust_field.empty() Not working
    school_adjust_field.send_keys(Keys.CONTROL + "a")  # Select all text
    school_adjust_field.send_keys(Keys.BACKSPACE)  # Delete selected text
